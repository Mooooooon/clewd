...
const {Main, AI, genericFixes, encodeDataJSON, indexOfAny, parseEvent, checkResErr} = require('./clewd-utils'), {DangerChars} = require('./clewd-message'), Decoder = new TextDecoder('utf-8');
...
class ClewdStream extends TransformStream {
    ...
    #build(selection) {
        ...
        return this.#streaming ? encodeDataJSON(completion) : JSON.stringify(completion, null, null, { encoding: 'utf8' });
    }
